...
def basic_analysis():
    ...
    data1 = db.get_data_from_db(db_tablename, colname='artist', colval='Eminem')
    data2 = db.get_data_from_db(db_tablename, colname='id',     colval='442f0f019d18a9a5acb583b79e474c9d')
    ...
    for i, ax in enumerate(axes.flat):
        ...
        ax.scatter(x2,    y2,    color="blue",  alpha=0.6, s=10)
        #ax.scatter(x_hat, y_hat, color="red",  alpha=0.6, s=10)
